        ...
        <section className="pt-32 pb-14 text-center px-4 sm:px-6" style={{ background: GRADIENT }}>
          <div className="max-w-2xl mx-auto">
            ...
            >
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full" style={{ background: "rgba(255,255,255,0.12)", border: "1px solid rgba(255,255,255,0.25)" }}>
                <span className="text-xs font-semibold text-white">Bundle 2 Eventos — 10% de descuento</span>
              </div>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full" style={{ background: "rgba(255,255,255,0.12)", border: "1px solid rgba(255,255,255,0.25)" }}>
                <span className="text-xs font-semibold text-white">Total Pass 3 Eventos — 20% de descuento</span>
              </div>
            </motion.div>
          </div>
        </section>
