...
const novedades = [
  {
    ...
    titulo: "The Art of Brand — Ciudad de México",
    descripcion: "La experiencia de marca más curada del año llega a CDMX. Cupos limitados.",
    fecha: "Próximamente",
  ...
  },
  {
    ...
    descripcion: "El programa de formación grupal más esperado comienza el 1° de julio.",
    fecha: "1 julio 2026",
  ...
  },
  {
    ...
    titulo: "Nuevo episodio disponible",
    descripcion: "Conversaciones sobre marca personal, estrategia y crecimiento empresarial.",
    fecha: "Disponible en Spotify",
    href: "/podcast",
  },
];
