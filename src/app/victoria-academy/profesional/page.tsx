...
import { CheckCircle2, XCircle, Clock, Library, Map as MapIcon, ScrollText, ShieldCheck, ChevronDown, CalendarDays, Star } from "lucide-react";
        ...
        <section className="py-16 sm:py-20 px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center mb-8">
            ...
            <h2 className="font-extrabold text-2xl sm:text-3xl tracking-tight mb-4" style={{ color: HEAD }}>
              ...
              <span style={{ color: ACCENT }} className="italic">talleres previos.</span>
            </h2>
