        ...
        <section className="pt-32 pb-14 text-center px-4 sm:px-6" style={{ background: GRADIENT }}>
          <div className="max-w-2xl mx-auto">
            ...
            <motion.div
              ...
              className="mt-6 flex items-center justify-center gap-2.5 overflow-x-auto pb-1 max-w-full"
            >
              <div className="flex-shrink-0 inline-flex items-center gap-2 px-4 py-2 rounded-full whitespace-nowrap" style={{ background: "rgba(255,255,255,0.95)" }}>
              ...
              <div className="flex-shrink-0 inline-flex items-center gap-1.5 px-3.5 py-2 rounded-full whitespace-nowrap" style={{ background: "rgba(255,255,255,0.12)", border: "1px solid rgba(255,255,255,0.25)" }}>
