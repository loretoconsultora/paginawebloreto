      ...
      <main className="min-h-screen" style={{ background: "#fafafa" }}>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 -mt-6 pb-20">
          ...
          >
            ...
            <div className="rounded-2xl p-5" style={{ background: "rgba(62,126,202,0.06)", border: "1px solid rgba(62,126,202,0.2)" }}>
              <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: "#3E7ECA" }}>Sí vendemos</p>
              <div className="flex flex-col gap-2.5">
                {SI_VENDE.map((t) => (
                  <div key={t} className="flex items-start gap-2 text-sm text-grafito/75 font-medium">
                    <CheckCircle2 size={15} className="flex-shrink-0 mt-0.5" style={{ color: "#3E7ECA" }} />
                    {t}
                  </div>
                ))}
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {ENTREGABLES.map((e) => (
                <div key={e.titulo} className="rounded-xl p-5 bg-white" style={{ border: "1px solid rgba(58,63,75,0.08)" }}>
                  <e.icon size={20} style={{ color: "#3E7ECA" }} className="mb-2" />
          ...
          <motion.div
            ...
            style={{ background: "rgba(62,126,202,0.06)", border: "1px solid rgba(62,126,202,0.2)" }}
          >
          ...
          <motion.div
            ...
            style={{ boxShadow: "0 4px 24px rgba(0,0,0,0.06)" }}
          >
            <ShieldCheck size={28} style={{ color: "#3E7ECA" }} className="flex-shrink-0 mt-0.5" />
            <div>
