...
const novedades = [
  {
    ...
    subtitulo: "Ciudad de México & Querétaro",
    descripcion: "Eventos de autor que combinan talleres de negocios, marketing y branding con experiencias íntimas, estéticas y profundamente intencionadas a través del arte.",
    bullets: [
      "📍 CDMX · Mimbre, Colonia San Rafael",
      "7, 8 y 9 de julio",
      "📍 Querétaro · Alva Coffee & Health Bar, Colonia El Refugio",
      "10 y 11 de julio",
    ],
  ...
  },
  {
    ...
    bullets: [
      ...
      "🚀 Inicio: miércoles 15 de julio · Solo 45 lugares",
    ],
    cta: "Quiero mi lugar →",
  ...
  },
  {
    tipo: "Podcast",
    icono: Mic,
    titulo: "\"Marketing Bloom\"",
    subtitulo: "1° Episodio YA DISPONIBLE",
    descripcion: "En nuestro primer capítulo de la Sección Marketing Snacks abordaremos las oportunidades que surgen para los negocios gracias a la gran tendencia mundial: Inteligencia Artificial.",
    bullets: [
      "Hablaremos sobre el qué, cómo, cuánto, dónde y porqué, más allá de todas las complexiones técnicas.",
    ],
